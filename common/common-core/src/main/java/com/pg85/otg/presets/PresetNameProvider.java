...
public class PresetNameProvider implements IPresetNameProvider
{
	...
	public String getPresetName(String worldName)
	{
		...
		if(worldName.equals("overworld") || worldName.equals(OTG.getEngine().getDimensionsConfig().WorldName))
    	{
    		return OTG.getEngine().getDimensionsConfig().Overworld.PresetName;	
    	} else {
