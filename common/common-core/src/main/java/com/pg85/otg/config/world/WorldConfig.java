...
public class WorldConfig extends WorldConfigBase
{
	...
	protected void writeConfigSettings(SettingsMap writer)
	{
		...
		writer.header2("Biome Groups",
			...
			"Tags/Categories - Instead of BiomeName, Forge Biome Dictionary id's and/or MC Biome Categories can be provided. ",
			"OTG fetches all registered non-OTG biomes using the specified category/tags and adds them to the biome group.",
			"A BiomeConfig using TemplateForBiome to target non-OTG biomes must exist for each biome, or it is skipped.",
			"Example: BiomeGroup(NormalBiomes, 1, 100, category.plains tag.overworld, tag.hot, tag.cold)",
			...
			"- \"category.\" and \"tag.\" exclude minecraft biomes by default, use \"mccategory.\" or \"mctag.\" to include them.",
			"Note:", 
