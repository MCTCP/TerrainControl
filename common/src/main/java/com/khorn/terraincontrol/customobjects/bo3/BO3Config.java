...
public class BO3Config extends CustomObjectConfigFile
{
    ...
    private void loadInheritedBO3()
    {
    	...
    	{    	
    		...
    		CustomObject parentBO3 = TerrainControl.getCustomObjectManager().getGlobalObjects().getObjectByName(this.inheritBO3, worldName);
			if(parentBO3 != null)
			{	
				...
				if(((BO3)parentBO3).getSettings().maxX > this.maxX)
				{
					this.maxX = ((BO3)parentBO3).getSettings().maxX;
				}
				if(((BO3)parentBO3).getSettings().minX < this.minX)
				{
					this.minX = ((BO3)parentBO3).getSettings().minX;
				}
				if(((BO3)parentBO3).getSettings().maxY > this.maxY)
				{
					this.maxY = ((BO3)parentBO3).getSettings().maxY;
				}
				if(((BO3)parentBO3).getSettings().minY < this.minY)
				{
					this.minY = ((BO3)parentBO3).getSettings().minY;
				}
				if(((BO3)parentBO3).getSettings().maxZ > this.maxZ)
				{
					this.maxZ = ((BO3)parentBO3).getSettings().maxZ;
				}
				if(((BO3)parentBO3).getSettings().minZ < this.minZ)
				{
					this.minZ = ((BO3)parentBO3).getSettings().minZ;
				}
					
				if(this.blocksOTGPlus == null)
				{
					this.blocksOTGPlus = ((BO3)parentBO3).getSettings().blocksOTGPlus.clone();
				} else {
				...
				{
					this.branchesOTGPlus = ((BO3)parentBO3).getSettings().branchesOTGPlus.clone();
				} else {
				...
				{
					this.modDataOTGPlus = ((BO3)parentBO3).getSettings().modDataOTGPlus.clone();
				} else {
				...
				{
					this.spawnerDataOTGPlus = ((BO3)parentBO3).getSettings().spawnerDataOTGPlus.clone();
				} else {
				...
				{
					this.particleDataOTGPlus = ((BO3)parentBO3).getSettings().particleDataOTGPlus.clone();
				} else {
				...
				{
					this.entityDataOTGPlus = ((BO3)parentBO3).getSettings().entityDataOTGPlus.clone();
				} else {
				...
				{
					this.bo3ChecksOTGPlus = ((BO3)parentBO3).getSettings().bo3ChecksOTGPlus.clone();
				} else {
				...
				getInheritedBO3s().addAll(((BO3)parentBO3).getSettings().getInheritedBO3s());
			}
	    	if(!inheritedBO3Loaded)
	    	{
	    		TerrainControl.log(LogMarker.INFO, "could not load BO3 parent for InheritBO3: " + this.inheritBO3 + " in BO3 " + this.getName());
	    	}
    	}
    }    
    ...
    private void readResources() throws InvalidConfigException
    {
    	...
    	{   		                
			...
			if(TerrainControl.getPluginConfig().SpawnLog)
			{
				if(illegalBlock)
				{
					TerrainControl.log(LogMarker.WARN, "Warning: BO3 contains Blocks or RandomBlocks that are placed outside the chunk(s) that the BO3 will be placed in. This can slow down world generation. BO3: " + this.getName());
				}
				if(illegalBlockCheck)
				{
					TerrainControl.log(LogMarker.WARN, "Warning: BO3 contains BlockChecks that are placed outside the chunk(s) that the BO3 will be placed in. This can slow down world generation. BO3: " + this.getName());
				}	        
				if(illegalModData)
				{
					TerrainControl.log(LogMarker.WARN, "Warning: BO3 contains ModData that may be placed outside the chunk(s) that the BO3 will be placed in. This can slow down world generation. BO3: " + this.getName());
				}         
				if(illegalSpawnerData)
				{
					TerrainControl.log(LogMarker.WARN, "Warning: BO3 contains a Spawner() that may be placed outside the chunk(s) that the BO3 will be placed in. This can slow down world generation. BO3: " + this.getName());
				}
				if(illegalParticleData)
				{
					TerrainControl.log(LogMarker.WARN, "Warning: BO3 contains a Particle() that may be placed outside the chunk(s) that the BO3 will be placed in. This can slow down world generation. BO3: " + this.getName());
				} 
				if(illegalEntityData)
				{
					TerrainControl.log(LogMarker.WARN, "Warning: BO3 contains an Entity() that may be placed outside the chunk(s) that the BO3 will be placed in. This can slow down world generation. BO3: " + this.getName());
				} 
			}
	    	...
	    	{    		  		    		
	    		...
	    		{
	    			TerrainControl.log(LogMarker.INFO, "BO3 " + this.name + " was too large, branching BO3's can be max 16x16 blocks.");
	    		...
	    		{
	    			TerrainControl.log(LogMarker.INFO, "BO3 " + this.name + " was too large, IsOTGPlus BO3's used as CustomStructure() can be max 16x16 blocks.");
    ...
    {   	
        ...
        if(!isOTGPlus)
        {
	        ...
	        for(BlockFunction func : getBlocks())
	        {
	        	writer.function(func);
	        }
        }
        ...
        if(!isOTGPlus)
        {
	        ...
	        for(BO3Check func : bo3ChecksOTGPlus)
	        {
	        	writer.function(func);
	        }
        }
        ...
        writer.comment("When IsOTGPlus is set to true: Branch(x,y,z,isRequiredBranch,branchName,rotation,chance[,anotherBranchName,rotation,chance[,...]][IndividualChance],branchDepth)");
        ...
        if(!isOTGPlus)
        {
	        ...
	        for(BranchFunction func : branchesOTGPlus)
	        {
	        	writer.function(func);
	        }
        }
        ...
        if(!isOTGPlus)
        {
	        ...
	        for(EntityFunction func : entityDataOTGPlus)
	        {
	        	writer.function(func);
	        }
        }
        ...
        if(!isOTGPlus)
        {
	        ...
	        for(ParticleFunction func : particleDataOTGPlus)
	        {
	        	writer.function(func);
	        }
        }
        ...
        if(!isOTGPlus)
        {
	        ...
	        for(SpawnerFunction func : spawnerDataOTGPlus)
	        {
	        	writer.function(func);
	        }
        }
        ...
        writer.comment("MCW has some built in ModData commands for basic mob and block spawning.");
        ...
        writer.comment("For mob spawning in OTG use: ModData(x,y,z,TC/MCW,mob/MobType/Count/Persistent/Name)");
        ...
        if(!isOTGPlus)
        {
	        ...
	        for(ModDataFunction func : modDataOTGPlus)
	        {
	        	writer.function(func);
	        }
        }        
