...
public interface LocalMaterialData
{
     ...
     * {@link #toDefaultMaterial() DefaultMaterial available}, this property
     * is defined by {@link DefaultMaterial#isSolid()}. Otherwise, it's up to
     * the mod that provided this block to say whether it's solid or not.
     * 
    ...
    /**
     * Gets the default material belonging to this material. The block data
     * will be lost. If the material is not one of the vanilla Minecraft
     * materials, {@link DefaultMaterial#UNKNOWN_BLOCK} is returned.
     * 
