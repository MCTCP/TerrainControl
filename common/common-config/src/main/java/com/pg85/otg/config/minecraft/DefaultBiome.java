...
import com.pg85.otg.config.minecraft.MinecraftBiomeTemplates.*;
...
public enum DefaultBiome
{
    ...
    public BiomeLoadInstruction getLoadInstructions(MojangSettings mojangSettings, int maxWorldHeight, ILogger logger)
    {
        try
        {
        ...
        {
        	logger.log(LogMarker.FATAL, "Failed to create default biome");
