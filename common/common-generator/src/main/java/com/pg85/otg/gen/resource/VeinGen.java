...
public class VeinGen extends Resource
{
    ...
    public VeinGen(IBiomeConfig biomeConfig, List<String> args, ILogger logger, IMaterialReader materialReader) throws InvalidConfigException
    {
        ...
        minAltitude = readInt(args.get(7), Constants.WORLD_DEPTH,
    		Constants.WORLD_HEIGHT - 1);
        maxAltitude = readInt(args.get(8), minAltitude,
    		Constants.WORLD_HEIGHT - 1);
        sourceBlocks = readMaterials(args, 9, materialReader);
    }
