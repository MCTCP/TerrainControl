...
public class BO4WeightedBranchFunction extends BO4BranchFunction
{
    ...
    public BO4WeightedBranchFunction rotate(Rotation rotation, String presetName, Path otgRootFolder, boolean spawnLog, ILogger logger, CustomObjectManager customObjectManager, IMaterialReader materialReader, CustomObjectResourcesManager manager, IModLoadedChecker modLoadedChecker)
    {
