...
public class BiomeConfig extends ConfigFile
{
    ...
    protected void ReadConfigSettings()
    {
        ...
        this.SurfaceBlock = this.ReadModSettings(PTMDefaultValues.SurfaceBlock.name(), this.DefaultSurfaceBlock);
        this.GroundBlock = this.ReadModSettings(PTMDefaultValues.GroundBlock.name(), this.DefaultGroundBlock);
