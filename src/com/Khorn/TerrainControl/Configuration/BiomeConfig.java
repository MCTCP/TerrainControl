...
public class BiomeConfig extends ConfigFile
{
    ...
    protected void WriteConfigSettings() throws IOException
    {
        ...
        WriteComment("  You have BiomeSize:1 in Desert and Plains biome and BiomeSize:0 in all other - this mean Desert have 50% and Plains have another 50%");
        WriteComment("  You have BiomeSize:3 in Desert and BiomeSize:1 in Plains and BiomeSize:0 in all other - this mean Desert have 3/4 and Plains have 1/4. ");
        WriteComment("  You have BiomeSize:1 in all - this mean each biome have 1/Biome_Count chane to spawn");
