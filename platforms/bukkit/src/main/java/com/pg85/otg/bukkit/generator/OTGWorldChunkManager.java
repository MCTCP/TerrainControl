 ...
 */
public class OTGWorldChunkManager extends WorldChunkManager
{
    private BukkitWorld localWorld;
    private BiomeGenerator biomeGenerator;

    public OTGWorldChunkManager(BukkitWorld world, BiomeGenerator biomeGenerator)
    {
    ...
    public BiomeBase[] getBiomes(BiomeBase[] paramArrayOfBiomeBase, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
    {
        ...
        {
            paramArrayOfBiomeBase[i] = ((BukkitBiome)localWorld.getBiomeByOTGIdOrNull(arrayOfInt[i])).getHandle();
        }
    ...
    public BiomeBase[] a(BiomeBase[] paramArrayOfBiomeBase, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
    {
        ...
        for (int i = 0; i < paramInt3 * paramInt4; i++)
        {
            paramArrayOfBiomeBase[i] = ((BukkitBiome)localWorld.getBiomeByOTGIdOrNull(localObject[i])).getHandle();
        }
