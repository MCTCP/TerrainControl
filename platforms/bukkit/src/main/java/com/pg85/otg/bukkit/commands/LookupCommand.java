...
public class LookupCommand extends BaseCommand
{
    ...
    public boolean onCommand(CommandSender sender, List<String> args)
    {
        ...
        if (biomeId == -1)
        {
            ...
            {
                sender.sendMessage(
                        MESSAGE_COLOR + "Biome \"" + VALUE_COLOR + biomeNameOrID + MESSAGE_COLOR + "\" is currently registered with ID " + VALUE_COLOR + targetBiome.getIds().getOTGBiomeId());
            } else {
            ...
            {
                sender.sendMessage(
                        MESSAGE_COLOR + "Biome ID " + VALUE_COLOR + biomeId + MESSAGE_COLOR + " currently belongs to biome \"" + VALUE_COLOR + targetBiome.getName() + MESSAGE_COLOR + "\"");
            } else {
