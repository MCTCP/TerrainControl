...
public class StructureCommand
{
	public static boolean execute(CommandSender sender, String[] args)
	{
		...
		if(worldInfoChunk != null)
		{
			...
			IMaterialReader materialReader = OTG.getEngine().getPresetLoader().getMaterialReader(((OTGSpigotChunkGen)((CraftWorld)((Player)sender).getWorld()).getGenerator()).generator.getPreset().getFolderName());
