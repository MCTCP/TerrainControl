...
public class TCGuiWorldSelection extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void confirmClicked(boolean ok, int worldId)
    {
		...
		TCGuiListWorldSelectionEntry selectedWorld = this.selectionList.getSelectedWorld();
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            TCGuiListWorldSelectionEntry guilistworldselectionentry = this.selectionList.getSelectedWorld();
    ...
    public void initGui()
    {
        ...
        this.selectionList = new TCGuiListWorldSelection(this, this.mc, this.width, this.height, 32, this.height - 64, 36);
        this.postInit();
    }
    ...
    public void selectWorld(@Nullable TCGuiListWorldSelectionEntry entry)
    {
