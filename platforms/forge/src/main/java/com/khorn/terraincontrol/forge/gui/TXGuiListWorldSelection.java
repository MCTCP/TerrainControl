...
public class TXGuiListWorldSelection extends GuiListExtended
{
    ...
    private final TXGuiWorldSelection worldSelectionObj;
    private final List<TXGuiListWorldSelectionEntry> entries = Lists.<TXGuiListWorldSelectionEntry>newArrayList();
    /** Index to the currently selected world */
    private int selectedIdx = -1;

    public TXGuiListWorldSelection(TXGuiWorldSelection p_i46590_1_, Minecraft clientIn, int p_i46590_3_, int p_i46590_4_, int p_i46590_5_, int p_i46590_6_, int p_i46590_7_)
    {
    ...
    public void refreshList()
    {
        ...
        {
            this.entries.add(new TXGuiListWorldSelectionEntry(this, worldsummary, this.mc.getSaveLoader()));
        }
    }
     ...
     */
    public TXGuiListWorldSelectionEntry getListEntry(int index)
    {
        return (TXGuiListWorldSelectionEntry)this.entries.get(index);
    }
    ...
    @Nullable
    public TXGuiListWorldSelectionEntry getSelectedWorld()
    {
        return this.selectedIdx >= 0 && this.selectedIdx < this.getSize() ? this.getListEntry(this.selectedIdx) : null;
    }

    public TXGuiWorldSelection getGuiWorldSelection()
    {
