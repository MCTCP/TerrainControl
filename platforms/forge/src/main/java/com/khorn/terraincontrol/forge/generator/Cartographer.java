...
{ 
	...
	{		
		...
		ForgeWorld overWorld = (ForgeWorld)((ForgeEngine)TerrainControl.getEngine()).getWorld(overWorldServer);
    ...
    public static void CreateBlockWorldMapAtSpawn(ChunkCoordinate chunkCoord, boolean unloading)
    {
		...
		{		
	    	...
	    	if(highestBlockY < 0)
	    	{
	    		...
	    		material = TerrainControl.toLocalMaterialData(replaceByMaterial, 15);
	    	}
	    	...
	    	/*
	   		else if(!unloading && playerInRange && playersInChunk.size() == 0)
	   		{
		    	...
		    	if(mobsInChunk.size() > 0)
		    	{
		    		...
		    		LocalMaterialData playerHead = TerrainControl.toLocalMaterialData(DefaultMaterial.SKULL, 3);
	    	...
	    	*/
	    	...
	    	{	    		
		    	...
		    	//{
					//LocalMaterialData playerSign = TerrainControl.toLocalMaterialData(DefaultMaterial.SIGN_POST, 0);
    ...
    {        	
	    ...
	    */    
    	...
    	for(DefaultMaterial replacematerial : TransparentBlocks)
    	{
    		...
    		{
    			return TerrainControl.toLocalMaterialData(DefaultMaterial.GLASS, 0);
    		}
    	}
    	for(DefaultMaterial replacematerial : WhiteBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 0);
    		}
    	}
    	for(DefaultMaterial replacematerial : OrangeBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			...
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 1);
    		}
    	}
    	for(DefaultMaterial replacematerial : MagentaBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 2);
    		}
    	}
    	for(DefaultMaterial replacematerial : LightBlueBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 3);
    		}
    	}
    	for(DefaultMaterial replacematerial : YellowBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 4);
    		}
    	}
    	for(DefaultMaterial replacematerial : LimeBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			...
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 5);
    		}
    	}
    	for(DefaultMaterial replacematerial : PinkBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 6);
    		}
    	}
    	for(DefaultMaterial replacematerial : GrayBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 7);
    		}
    	}
    	for(DefaultMaterial replacematerial : LightGrayBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 8);
    		}
    	}
    	for(DefaultMaterial replacematerial : CyanBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 9);
    		}
    	}
    	for(DefaultMaterial replacematerial : PurpleBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 10);
    		}
    	}
    	for(DefaultMaterial replacematerial : BlueBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 11);
    		}
    	}
    	for(DefaultMaterial replacematerial : BrownBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 12);
    		}
    	}
    	for(DefaultMaterial replacematerial : GreenBlocks)
    	{
    		...
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 13);
    		}
    	}
    	for(DefaultMaterial replacematerial : RedBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 14);
    		}
    	}
    	for(DefaultMaterial replacematerial : BlackBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, 15);
    		}
    	}
    	for(DefaultMaterial replacematerial : ColoredBlocks)
    	{
    		if(replacematerial.equals(materialToReplace.toDefaultMaterial()))
    		{
    			return TerrainControl.toLocalMaterialData(replaceByMaterial, materialToReplace.getBlockData());
    		}
    	}
